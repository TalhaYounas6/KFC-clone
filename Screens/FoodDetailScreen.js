...
export default function FoodDetailScreen({ route }) {
 ...
 useEffect(() => {
    if (foodItem && foodItem.description) {
      const regularDrinkCount = (foodItem.description.match(/1 regular drink/g) || []).length;
      const largeDrinkCount = (foodItem.description.match(/1\.5L drink/g) || []).length;
  ...
  const [drinks, setDrinks] = useState([
    ...
    },
    {
      ...
      price: 180,
      quantity: 0,
      image: 'https://www.kfcpakistan.com/images/62153aa0-0513-11ee-8eee-c7aabf77bad4-Dew-2023-06-07091210.png',
    },
  ]);

  const [largeDrinkOptions, setLargeDrinkOptions] = useState([
    {
      id: 1,
      name: 'Pepsi 1.5L',
      price: 340,
 ...
 const [addOns, setAddOns] = useState([
    {
      ...
      quantity: 0,
      image:
        'https://www.kfcpakistan.com/images/6249b820-0513-11ee-9e45-cb0ed000d4a6-LargeFries-2023-06-07091210.png',
    },
    {
      id: 2,
      name: 'Mayo Dip',
      ...
      quantity: 0,
      image:
        'https://www.kfcpakistan.com/images/ddb356e0-ea4e-11ed-bcba-6f242cd5238e-mayo-2023-05-04073956.png',
    },
    {
      id: 3,
      name: 'Dinner Roll',
      ...
      quantity: 0,
      image:
        'https://www.kfcpakistan.com/images/6249b820-0513-11ee-9e45-cb0ed000d4a6-Dinner-Roll-copy-2023-06-07091210.png',
    },
    {
      id: 4,
      name: 'Boneless Strips (2 pcs)',
      price: 200,
      quantity: 0,
      image:
        'https://www.kfcpakistan.com/images/ee40ad00-c522-11ee-aed0-3f3f2586d355-Chicken-Strips-2024-02-06190711.png',
    },
    {
      id: 5,
      name: 'Coleslaw',
      ...
      quantity: 0,
      image:
        'https://www.kfcpakistan.com/images/61ec55e0-0513-11ee-aee5-69eb5757a047-Coleslaw-2023-06-07091210.png',
    },
    { 
      id: 6,
      name: 'Large Fries',
    ...
    },
    {
      ...
      quantity: 0,
      image:
        'https://www.kfcpakistan.com/images/dd4a34d0-ea4e-11ed-830c-4fa21ffc6c4a-ches-2023-05-04073955.png',
    },
    {
      id: 8,
      name: 'One Pc chicken',
      ...
      quantity: 0,
      image:
        'https://www.kfcpakistan.com/images/62153aa0-0513-11ee-8eee-c7aabf77bad4-1PcChicken-2023-06-07091210.png',
    },
  ]);

  const handleAddToBucket = () => {
    if (selectedRegularDrinks.some(drink => drink === null) || selectedLargeDrinks.some(drink => drink === null)) {
      Alert.alert('Required Selection', 'Please select all required drinks before adding to bucket.');
      return;
    }
    ...
    const selectedItems = [
      {
        ...
        quantity: quantity,
        addedItems: [
          ...selectedRegularDrinks.filter(Boolean).map(drink => ({ ...drink, quantity: 1 })),
          ...selectedLargeDrinks.filter(Boolean).map(drink => ({ ...drink, quantity: 1 })),
    ...
    addToBucket(selectedItems);
    navigation.navigate('BucketContent');
  };
  ...
  const renderItems = useCallback((items, itemType) =>
    items.map((item) => (
  ...
  const renderDrinkOptions = useCallback((drinkOptions, selectedDrinks, type, index) => {
    return drinkOptions.map((drink) => (
      ...
      >
        ...
        <View style={[styles.radioButton2, selectedDrinks[index]?.id === drink.id && styles.radioButtonSelected]} />
      </TouchableOpacity>
    ));
      ...
      <View style={styles.content}>
        ...
        {regularDrinks.map((_, index) => (
          <View key={`regular-drink-${index}`}>
            <View style={styles.optionContainer}>
              <Text style={styles.optionTitle}>Regular Drink {index + 1}</Text>
              <Text style={styles.optionRequired}>Required</Text>
            </View>
            {renderDrinkOptions(drinks, selectedRegularDrinks, 'regular', index)}
          </View>   
        ))}
        ...
        {largeDrinks.map((_, index) => (
          <View key={`large-drink-${index}`}>
            ...
            {renderDrinkOptions(largeDrinkOptions, selectedLargeDrinks, 'large', index)}
          </View>
        ))}
  ...
  ), [foodItem, renderItems, drinks, largeDrinkOptions, addOns, regularDrinks, largeDrinks, scrollY, selectedRegularDrinks, selectedLargeDrinks]);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={styles.addToBucketButton} onPress={handleAddToBucket}>
