...
import {
  View, Text, Image, TouchableOpacity, StyleSheet, Dimensions, FlatList, TextInput, Platform, StatusBar
} from 'react-native';
  ...
  const renderProductItem = useCallback(({ item }: { item: Product }) => (
    <View style={styles.productItem}>
      ...
      <View style={styles.productFooter}>
        ...
        <TouchableOpacity style={styles.addButton} onPress={()=>handleAddToBucket(item)}>
          <Text style={styles.addButtonText}>ADD TO BUCKET</Text>
        </TouchableOpacity>
      </View>
      <TouchableOpacity style={styles.customizeButton} onPress={()=>handleCustomizePress(item)} >
