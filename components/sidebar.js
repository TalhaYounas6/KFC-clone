          ...
          <>
            ...
            <View style={styles.loginSection}>
              ...
              <View style={styles.loginText}>
                <Text style={styles.loginTitle}>Login to unlock exclusive</Text>
                <Text style={styles.loginSubtitle}>Offers and Discounts</Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  topSpacer: {
    height: 40, // Adjust this value to move content further down if needed
  },
  loginSection: {
    flexDirection: 'row',
    alignItems: 'center',
